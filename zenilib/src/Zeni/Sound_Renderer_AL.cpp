...
namespace Zeni {
  ...
  Sound_Renderer_AL::ov_clear_fcn Sound_Renderer_AL::g_ov_clear = 0;
  Sound_Renderer_AL::ov_info_fcn Sound_Renderer_AL::g_ov_info = 0;
  Sound_Renderer_AL::ov_fopen_fcn Sound_Renderer_AL::g_ov_fopen = 0;
  Sound_Renderer_AL::ov_pcm_total_fcn Sound_Renderer_AL::g_ov_pcm_total = 0;
  Sound_Renderer_AL::ov_read_fcn Sound_Renderer_AL::g_ov_read = 0;
