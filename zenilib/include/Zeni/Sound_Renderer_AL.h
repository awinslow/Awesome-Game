...
namespace Zeni {
  ...
  public:
    ...
    typedef int (*ov_clear_fcn)(OggVorbis_File *vf);
    typedef vorbis_info * (*ov_info_fcn)(OggVorbis_File *vf,int link);
    typedef int (*ov_fopen_fcn)(const char *path,OggVorbis_File *vf);
    typedef ogg_int64_t (*ov_pcm_total_fcn)(OggVorbis_File *vf,int i);
    typedef long (*ov_read_fcn)(OggVorbis_File *vf,char *buffer,int length,int bigendianp,int word,int sgned,int *bitstream);
    ...
    static ov_clear_fcn ov_clear() {return g_ov_clear;}
    static ov_info_fcn ov_info() {return g_ov_info;}
    static ov_fopen_fcn ov_fopen() {return g_ov_fopen;}
    static ov_pcm_total_fcn ov_pcm_total() {return g_ov_pcm_total;}
    static ov_read_fcn ov_read() {return g_ov_read;}
  ...
  private:
    ...
    HMODULE m_libvorbisfile;
    static ov_clear_fcn g_ov_clear;
    static ov_info_fcn g_ov_info;
    static ov_fopen_fcn g_ov_fopen;
    static ov_pcm_total_fcn g_ov_pcm_total;
    static ov_read_fcn g_ov_read;
