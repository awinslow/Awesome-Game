...
namespace Zeni {
  ...
  struct Color;
  class ZENI_GRAPHICS_DLL Texture_DX9;
  ...
  public:
    ...
    Texture * create_Texture(SDL_Surface * const &surface, const bool &repeat); ///< Function for creating a Texture from an SDL_Surface
    Texture * create_Texture(const Point2i &size, const bool &repeat); ///< Function for creating a Texture for render-to-texture
    Font * create_Font(const String &filename, const bool &bold, const bool &italic, 
