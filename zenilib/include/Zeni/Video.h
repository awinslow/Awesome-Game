...
namespace Zeni {
  ...
  class ZENI_GRAPHICS_DLL Fragment_Shader;
  ...
  class ZENI_GRAPHICS_DLL Vertex_Shader;
...
#pragma warning( pop )
  ...
  public:
    ...
    virtual Texture * create_Texture(SDL_Surface * const &surface, const bool &repeat) = 0; ///< Function for creating a Texture from an SDL_Surface
    ...
    virtual Font * create_Font(const String &filename, const bool &bold, const bool &italic, 
